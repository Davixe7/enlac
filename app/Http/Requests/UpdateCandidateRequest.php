...
class UpdateCandidateRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'contacts.*.enlac_responsible'     => 'nullable|boolean',
            'contacts.*.is_emergency_contact'  => 'boolean',
            'contacts.*.legal_guardian'        => 'nullable|boolean',
            'contacts.*.email'                 => 'nullable|email',
            'contacts.*.whatsapp'              => 'nullable',
            'contacts.*.home_phone'            => 'nullable',
            'contacts.*.street'                => 'nullable',
            'contacts.*.neighborhood'          => 'nullable',
            'contacts.*.state'                 => 'nullable',
            'contacts.*.postal_code'           => 'nullable',
            'contacts.*.exterior_number'       => 'nullable',
            'contacts.*.city'                  => 'nullable',
            'contacts.*.country'               => 'nullable',
            'contacts.*.rfc'                   => [
                'nullable',
                'string',
            ...
            'evaluation_schedule.evaluator_id' => 'nullable',
            'evaluation_schedule.date'         => 'nullable',
        ];
    }
